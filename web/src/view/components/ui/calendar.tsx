  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-heading text-zinc-50 hover:bg-zinc-900 hover:text-zinc-50 focus:bg-heading focus:text-zinc-50 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-50 dark:hover:text-zinc-900 dark:focus:bg-zinc-50 dark:focus:text-zinc-900",
